...
Definition of Done:
- [ ] Интерактивные элементы не меньше 44×44, включая невидимую область нажатия
- [ ] Между соседними целями минимум 8px
- [ ] Замер повторён скриптом и приложен к задаче
- [ ] Визуальные размеры не раздуты ради области нажатия
