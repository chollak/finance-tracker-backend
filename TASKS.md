...
| 1.5. Доверие к цифрам | UI не противоречит семантике (ревью 2026-08-13) | FT-052, FT-053, FT-054 |
| 2. Качество ежедневного экрана | Список и бюджеты читаются и не врут | FT-055, FT-056, FT-057, FT-058 |
| 3. Порядок в трекинге и тулинге | Один источник правды, рабочие скрипты | FT-049, FT-050, FT-064, FT-048 |
| 4. Полировка под гайдлайны | Цвет, шрифт, язык | FT-059, FT-060, FT-061 |
| 5. Структура и продукт P1 | Приоритеты разделов, система внимания | FT-062, FT-063, FT-051 |
| — отложено | Требует живого прода | FT-046 |

Веха 1.5 идёт сразу за вехой 1: пока аналитика противоречит главному экрану, пользоваться продуктом как источником правды нельзя.
