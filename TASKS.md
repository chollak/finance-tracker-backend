...
Definition of Done:
- [ ] Палитра диаграмм приведена к шести токенам `--color-chart-1…6`; лишние категории сворачиваются в «Другое»
- [ ] Цвет оценки здоровья согласован со смыслом значения: сейчас «Хорошо» окрашено в `warning`
- [ ] Бейдж статуса долга переведён в существующие роли: сейчас синий, которого нет среди четырёх
