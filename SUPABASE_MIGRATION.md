...
> **⚠️ Не активный путь (баннер добавлен 2026-08-16).** Supabase-проект стоит на паузе, текущая работа идёт локально на `DATABASE_TYPE=sqlite`. Этот документ сохранён как историческое руководство.
>
> SQL-миграции и любые изменения в Supabase выполняются **только с отдельного явного разрешения Шукура** — не применяйте скрипты ниже по ходу обычной задачи.
>
> Актуальные источники правды: [TASKS.md](TASKS.md) (Active Plan) и [CLAUDE.md](CLAUDE.md).
