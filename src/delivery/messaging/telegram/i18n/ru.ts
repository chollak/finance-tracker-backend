...
export const RU = {
  ...
  welcome: {
    ...
    // Список команд убран 2026-08-26 вместе с их регистрацией (src/frozen.ts).
    // Приветствие не должно обещать того, чего бот больше не умеет.
    description: `
Я помогу отслеживать твои расходы и доходы.

<b>Как пользоваться:</b>
Отправь голосовое сообщение или текст
Например: <i>кофе 25000</i> или <i>зарплата 5000000</i>

Запишу сразу — подтверждать ничего не нужно.
Если ошибусь, поправишь одной кнопкой.

Всё остальное — в приложении, кнопка ниже.
    `.trim(),
...
/week - Еженедельный обзор прошлой недели
...
Нажмите на категорию ниже
  ...
  errors: {
    ...
    // Внешний сервис (OpenAI) не ответил вовремя. Показывается вместо технического
    // 'External service error: OpenAI Transcription', которое пользователю ничего не говорит.
    aiUnavailable: 'Не смог разобрать сообщение — сервис распознавания не ответил. Попробуйте ещё раз.',
  },
